...
public class TutoringViewHolder extends RecyclerView.ViewHolder implements
        View.OnClickListener,
        View.OnCreateContextMenuListener {

    public TextView txtBookingId, txtCoursecode, txtDatetime, txtLoc, txtBookingStatus, txtTotPay, txtBookingPhone, txtTutorName, btnCancel;

    private OnItemClickListener itemClickListener;

    public TutoringViewHolder(View itemView){
        super(itemView);
